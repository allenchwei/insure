...
var configApi = { apiUrl: "http://m.turntable8.com/", xbbApiUrl: "http://xbbstagingapi.data88.cn/" };
...
function actService() {
    var t = function(t) { var i = null; return i = init.submit_switch ? n(t) : $.post(configApi.apiUrl + "act/subdata.do", t) },
        ...
        c = function(t) { return $.get(configApi.apiUrl + "act/index/index_submit?channel_map_id=" + t) },
        ...
        g = function(t) {
            if (!init.submit_switch || newtankParameter.activityCode && newtankParameter.activityCode.match("loan")) {
                var n = configApi.apiUrl + "act/index/index_submit",
